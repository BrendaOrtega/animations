  ...
  return (
    <>
      <motion.article
        ...
        className="h-[50vh] relative overflow-hidden bg-white dark:bg-dark"
      >
        <section>
...
const AnimatedBanner = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "h-16 absolute left-[-10%] top-[45%] flex w-[150vw]",
        bgClass
      )}
    >
      <motion.p
        ref={p}
        style={{ x }}
        className="uppercase text-white flex items-center h-full font-extrabold lg:text-3xl text-2xl gap-10 whitespace-nowrap font-sans translate-x-[-100%]"
      >
        {children ? (
          children
        ) : (
